Meteor.methods({
    ...
    inviteMembersByEmail: function(data) {
        ...
        emails.forEach(function (email) {
            Meteor.call('prepareMembership', email.address, doc, docType, item, invited);
        });

    },
    prepareMembership: function(email, doc, docType, item, invited) {
        ...
        if(!Memberships.findOne({email: email})) {
            ...
            if(invited) {
                id = Meteor.call('_createMembership', doc, docType, invited, email);
