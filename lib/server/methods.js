Meteor.methods({
    requestMembershipByEmail: function(doc, docType) {
        ...
        item = Meteor.call('_getItem', doc, docType);

        owner = Meteor.call('_getItemOwner', item.owners[0]);
    ...
    _getItemOwner: function(owner) {
        this.unblock();
        console.log('_getItemOwner: ' + owner);
